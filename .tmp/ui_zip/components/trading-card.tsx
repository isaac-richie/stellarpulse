...
import { ArrowUpRight, BookmarkPlus, Clock, TrendingUp, TrendingDown, Zap } from "lucide-react"
...
export function TradingCard({ market, index }: TradingCardProps) {
  ...
  const [buying, setBuying] = useState<"yes" | "no" | null>(null)
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        ...
        <div className="grid grid-cols-2 gap-2 mt-1">
          ...
          <button
            onClick={() => setBuying("no")}
            className={cn(
              "flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-bold transition-all duration-200 border",
              buying === "no"
                ? "bg-[oklch(0.58_0.2_25)] border-[oklch(0.58_0.2_25)] text-[oklch(0.12_0.01_255)] scale-95"
        ...
        {buying && (
          <div className="mt-0.5 p-3 rounded-xl bg-[oklch(0.18_0.014_255)] border border-[oklch(0.25_0.016_255)] space-y-2.5">
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              <span>Amount (USDC)</span>
              <button
                className="text-[oklch(0.78_0.16_82)] font-medium hover:underline"
            ...
            <input
              ...
              min="0"
              step="1"
              className="w-full bg-[oklch(0.22_0.015_255)] border border-[oklch(0.28_0.018_255)] rounded-lg px-3 py-2 text-sm font-mono text-foreground placeholder:text-muted-foreground outline-none focus:border-[oklch(0.78_0.16_82/0.5)]"
              onClick={(e) => e.stopPropagation()}
            />
            <button
              className="w-full py-2 rounded-lg text-xs font-bold bg-[oklch(0.78_0.16_82)] text-[oklch(0.12_0.01_255)] hover:bg-[oklch(0.82_0.16_82)] transition-colors shadow-[0_0_16px_oklch(0.78_0.16_82/0.25)]"
              onClick={(e) => e.stopPropagation()}
            >
              Confirm {buying === "yes" ? "YES" : "NO"} Trade
